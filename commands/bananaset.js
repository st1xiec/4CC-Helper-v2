...
module.exports.help = {
    name: 'bananaset',
    aliases: ['bset', 'глобалустановить', 'установитьглобал', 'густановить', 'густ', 'setbananas', 'setban', 'установитьбананы'],
    description: 'Изменение количества бананов',
    usages: { '!bset @user#0001 1050': 'Изменит количество бананов @user#0001 на 1.050 ' },
